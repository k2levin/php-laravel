...
RUN apk add --no-cache --update alpine-sdk bash git libpng-dev mysql-client nano nginx nodejs nodejs-npm openrc openssh openssl php7 php7-bcmath php7-ctype php7-curl php7-dom php7-fileinfo php7-fpm php7-gd php7-json php7-mbstring php7-pdo php7-pdo_mysql php7-pecl-redis php7-phar php7-session php7-simplexml php7-tokenizer php7-xml php7-xmlwriter python3 tzdata vim yarn && \
# composer setup
